          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              <ul class="menu list-inline mb-0">
                ...
                <li class="list-inline-item"><a href="/conatact">Contact</a></li>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p class="text-center text-muted"><a href="/register" class="text-dark" data-toggle="modal" data-target="#login-modal1">Not registered yet?</a></p>
          </div>
        </div>
      </div>
    <!-- //*** Login Modal *** -->

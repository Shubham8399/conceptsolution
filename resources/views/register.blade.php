          ...
          <div class="modal-dialog modal-sm">
                  ...
                  <div class="flash-message">
                    ...
                    <div class="modal-body">
                      <form action="/insert_register" method="POST">
                        @csrf
                        <div class="form-group">
                          <input type="text" placeholder="Firstname" name="first_name" class="form-control" >
                          <small class="validation_message">@error('first_name'){{ $message }} @enderror</small>
                        </div>
                        <div class="form-group">
                          <input type="text" placeholder="Lastname" name="last_name" class="form-control">
                           <small class="validation_message">@error('last_name'){{ $message }} @enderror</small>
                        </div>
                        <div class="form-group">
                          <input type="number" placeholder="Mobile" name="mobile" class="form-control">
                           <small class="validation_message">@error('mobile'){{ $message }} @enderror</small>
                        </div>
                        <div class="form-group">
                          <input type="email" placeholder="Email" name="email" class="form-control">
                           <small class="validation_message">@error('email'){{ $message }} @enderror</small>
                        </div>
                        <div class="form-group">
                          <input type="password" placeholder="Password" name="password" class="form-control">
                           <small class="validation_message">@error('password'){{ $message }} @enderror</small>
                        </div>
                        <p class="text-center">

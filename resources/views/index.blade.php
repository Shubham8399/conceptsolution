    ...
    <header class="header mb-5">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              <ul class="menu list-inline mb-0">
                ...
                <li class="list-inline-item"><a href="/view">Recently viewed</a></li>
              </ul>
            </div>
          </div>
        </div>
     ...
     <nav class="navbar navbar-expand-lg">
      ...
      <div id="search" class="collapse">
        <div class="container">
          <form action="search.php" method="POST" role="search" class="ml-auto">
            <div class="input-group">
              <!-- <input type="text" placeholder="Search" class="form-control"> -->
                <select required="" class="form-control" name="v_shoes_for">
                    <option value="" selected="" disabled="">Shoes For</option>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#" data-toggle="modal" data-target="#login-modal1">Regiter</a></li>
            </ul>
          </div>
          <!-- /.col-lg-3-->
          <div class="col-lg-3 col-md-6">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p><strong>CubexO Software Soluton Private Ltd.</strong><br>2nd Floor M.R. Bussiness Pask<br>Khandwa Naka<br>Indore<br><strong>India</strong></p><a href="contact.html">Go to contact page</a>
          ...
          <div class="modal-body">
            <form action="login_logic.php" method="POST">
              <div class="form-group">
                <input id="email-modal" type="text" placeholder="email" name="email" class="form-control">
              </div>
              <div class="form-group">
            ...
            <p class="text-center text-muted"><a href="#" class="text-dark" data-toggle="modal" data-target="#login-modal1">Not registered yet?</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="/insert" method="POST">
              ...
              <div class="form-group">
                <input type="text" placeholder="Fircky Password" name="password" class="form-control">
              </div>
              <p class="text-center">
                <button type="submit" class="btn btn-primary"><i class="fa fa-sign-in"></i>Register Now</button>
              </p>
            </form>
          </div>
        </div>
    ...
    <div id="copyright">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <p class="text-center text-lg-right">Template design by <a href="https://bootstrapious.com/p/big-bootstrap-tutorial">CubexO Software Solution</a>

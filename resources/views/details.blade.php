              ...
              <div id="productMain" class="row">
                ...
                <div class="col-md-6">
                  <div class="box">
                    ...
                    <p class="price text-secondary"><del><?php echo $price.'RS';?></del></p>
                    <p class="price"><?php echo $final_price.'RS';?></p>
                    <p class="text-center buttons">
                      <a href="cart_logic.php?shoeid=<?php echo $shoeid;?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to cart</a>
